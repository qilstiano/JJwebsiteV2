...
const Implementation = () => {
  return (
    <Accordion className="px-5 lg:max-w-[80%] mx-auto py-8" type="single" collapsible>
      <AccordionItem value="usage-scenarios" className="border-none bg-[#8A74A5] rounded-sm">
        ...
        <AccordionContent className="pb-0 text-white text-lg bg-[#B29FD1] px-8 py-4">
      ...
      <AccordionItem value="step-by-step-guide" className="border-none bg-[#8A74A5] rounded-sm">
