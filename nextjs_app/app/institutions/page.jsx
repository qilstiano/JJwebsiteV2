...
const Home = () => {
  ...
  return (
    <main className="w-full pt-8 flex flex-col bg-[#674C93] min-h-screen">
      <Head>
      ...
      <section className="bg-[url('/images/Catalogue/InstitutionsMasthead.jpg')] bg-cover bg-center relative">
        ...
        <div className='max-w-6xl mx-auto relative z-30 min-h-[350px] flex flex-col justify-center px-5'>
          <h2 className='font-normal text-white text-5xl md:text-7xl'>Institutions</h2>
          <h2 className='font-bold text-white text-5xl md:text-7xl mt-3'>Level Up Classroom</h2>
          <h2 className='font-bold text-white text-5xl md:text-7xl mt-3'>Learning With Play</h2>
        </div>
      ...
      <section className='bg-[#674C93] pt-5 pb-10'>
        {renderSegment()}
      </section>
    </main>
  )
