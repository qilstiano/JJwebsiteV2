...
const Implementation = () => {
  return (
    <Accordion className="px-5 lg:max-w-[80%] mx-auto py-8" type="single" collapsible>
      <AccordionItem value="usage-scenarios" className="border-none bg-[#74939D] rounded-sm">
        ...
        <AccordionContent className="pb-0 text-white text-lg bg-[#88A7B1] px-8 py-4">
      ...
      <AccordionItem value="step-by-step-guide" className="border-none bg-[#74939D] rounded-sm">
