    ...
    <main className="w-full pt-8 flex flex-col bg-[#4B3372] min-h-screen">
      <section className="bg-[url('/images/Testimonials/TestimonialsMasthead.jpg')] bg-cover bg-center relative">
        ...
        <div className='max-w-6xl mx-auto relative z-30 min-h-[350px] flex flex-col justify-center px-5'>
          ...
          <h2 className='font-bold text-white text-5xl md:text-7xl mt-3'>Frequently Asked Questions</h2>
        </div>
      </section>
      ...
      <section className='bg-[#674C93] pt-16 pb-10'>
        <Accordion className="px-5 lg:max-w-[80%] mx-auto" type="single" collapsible>
          <AccordionItem value="institutions" className="border-none bg-[#8A74A5] rounded-sm">
            <AccordionTrigger className="text-white text-3xl md:text-5xl md:py-5 hover:no-underline px-10 text-left">For Institutions</AccordionTrigger>
          ...
          <AccordionItem value="organisations" className="border-none bg-[#306054] rounded-sm">
            <AccordionTrigger className="text-white text-3xl md:text-5xl md:py-5 hover:no-underline px-10 text-left">For Organisations</AccordionTrigger>
            <AccordionContent className="pb-0">
          ...
          <AccordionItem value="individuals" className="border-none bg-[#347184] rounded-sm">
            <AccordionTrigger className="text-white text-3xl md:text-5xl md:py-5 hover:no-underline px-10 text-left">For Individuals</AccordionTrigger>
            <AccordionContent className="pb-0">
          ...
          <AccordionItem value="account-management" className="border-none bg-[#73717D] rounded-sm">
            <AccordionTrigger className="text-white text-3xl md:text-5xl md:py-5 hover:no-underline px-10 text-left">Account Management</AccordionTrigger>
            <AccordionContent className="pb-0">
          ...
          <AccordionItem value="payment" className="border-none bg-[#73717D] rounded-sm">
            <AccordionTrigger className="text-white text-3xl md:text-5xl md:py-5 hover:no-underline px-10 text-left">Payment</AccordionTrigger>
            <AccordionContent className="pb-0">
              <Accordion className="bg-[#908E9C]" type="multiple" collapsible>
