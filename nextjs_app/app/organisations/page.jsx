...
const Home = () => {
  ...
  return (
    <main className="w-full pt-8 flex flex-col bg-[#306054] min-h-screen">
      <Head>
        <title>Organisations - Empower your team and community</title>
        <meta name="description" content="Empower your team and community" />
      ...
      <section className="bg-[url('/images/Catalogue/InstitutionsMasthead.jpg')] bg-cover bg-center relative">
        ...
        <div className='max-w-6xl mx-auto relative z-30 min-h-[350px] flex flex-col justify-center px-5'>
          <h2 className='font-normal text-white text-5xl md:text-7xl'>Organisations</h2>
          <h2 className='font-bold text-white text-5xl md:text-7xl mt-3'>Empower your team and community</h2>
        </div>
      ...
      <section className='bg-[#306054] pt-5 pb-10'>
        {renderSegment()}
      </section>
    </main>
  )
